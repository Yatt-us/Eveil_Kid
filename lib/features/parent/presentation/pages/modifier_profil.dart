...
class _ModifierProfilPageState extends ConsumerState<ModifierProfilPage> {
  ...
  void initState() {
    ...
    _nomController = TextEditingController(
      text: widget.parent.name.isNotEmpty ? widget.parent.name : 'Aminata DIARRA',
    );
    _emailController = TextEditingController(
      text: widget.parent.email.isNotEmpty ? widget.parent.email : 'aminata.diarra@gmail.com',
    );
  ...
  Future<void> _save() async {
    ...
    try {
      await ref.read(parentNotifierProvider.notifier).updateParentProfile(updated);
      if (mounted) {
            ...
            children: [
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipOval(
                        child: widget.parent.photoUrl != null && widget.parent.photoUrl!.isNotEmpty
                            ? Image.network(
              ...
              _buildFieldContainer(
                ...
                trailing: GestureDetector(
                  onTap: _pickDate,
                  child: const Icon(Icons.calendar_today_outlined, color: AppColors.textPrimary, size: 22),
                ),
                child: GestureDetector(
                  onTap: _pickDate,
                  child: Text(
  ...
  Widget _buildFieldContainer({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.textPrimary.withValues(alpha: 0.7), width: 1.2),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
