...
import '../../../../shared/widgets/jouet_bottom_navigation.dart';
...
class ActivitesListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      // Integration de la barre de navigation inférieure avec l'index 3 (Activités)
      bottomNavigationBar: const JouetBottomNavigation(
        currentIndex: 3,
      ),
    );
  }
