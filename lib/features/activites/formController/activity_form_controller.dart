...
String? pointsError;
  ...
  Future<void> _loadCategories() async {
    try {
      ...
      final result =
          await ref.read(
        categoriesActivesProvider.future,
      );
  ...
  void _loadExistingData() {
    ...
    dureeController.text =
        activite.dureeEnMinutes.toString();

    pointsController.text =
        activite.points.toString();

    selectedCategorieId =
        activite.categorieId;
  ...
  try {
    ...
    if (selectedImage != null && savedActivite.id != null) {
      try {
        ...
        errorMessage = 'Activité enregistrée mais erreur lors de l\'upload de l\'image';
        notifyListeners();
