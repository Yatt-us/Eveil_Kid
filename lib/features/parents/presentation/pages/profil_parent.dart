            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () => _pickImage(ctx, ref, parent, ImageSource.gallery),
                ),
                ListTile(
                  leading: CircleAvatar(
                  ...
                  Center(
                    child: Column(
                      children: [
                        Stack(
                          ...
                          children: [
                            AppAvatar(
                              ...
                              name: displayName,
                              radius: 50,
                              onTap: () => _showPhotoOptionsSheet(context, ref, parent),
                            ),
                            Positioned(
                              right: -2,
                              bottom: -2,
                        ...
                        if (parent.adresse != null && parent.adresse!.trim().isNotEmpty) ...[
