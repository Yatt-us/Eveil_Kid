...
//       builder: (context, state) => const JouetsScreen(utilisateurId: '0FCX2CD3IlcC2tPxiOujc0b0N9v1')
//       ),
//       GoRoute( 
//       path: AppRoutes.jouetdetail, 
//       builder: (context, state) => const JouetDetailScreen(jouet: , utilisateurId: '0FCX2CD3IlcC2tPxiOujc0b0N9v1',), 
//       ), 
//     ],
